...
public class ImageTool {
     ...
     * @param maxHeight         The maximum height the thumbnail is allowed to have
     * @param interPolationType Is for you to choose what interpolation you wish to use 1 :
     ...
     *                          size(byte)
     * @param renderingType     Too choose the rendering type 1: Uses scale // Better on
     ...
     *
     * @param edgeX Horizontal crop. The image will be cropped edgeX/2 on both
     *              sides.
     * @param edgeY Vertical crop. The image will be cropped edgeY/2 on top and
     *              bottom.
     */
    @SuppressWarnings("unchecked")
